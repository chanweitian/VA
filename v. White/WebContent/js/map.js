$(document).ready(function() {
	var landColor = d3.rgb("#FAF0E6"); 
	var width = height = null;

	var chart_svg = d3.select("#chart").append("svg");

	var background = chart_svg.append("rect").attr("fill", "#ffffff");
...
//		$("#per-capita").fadeIn();
	...
	function slideSelected() {
		...
		case 0: // The HIV-Tuberculosis Conundrum
		...
		case 1: // A First-Class Healthcare System
			$("#color-legend").fadeOut();
			selectCountry("SWE");
			selectYear(2011);
			showHealthcare();
		...
		case 2:  // Is there an Efficiency Point?
			$("#color-legend").fadeOut();
			selectCountry("MEX");
			selectYear(2011);
			hideTB();
		...
		case 3: //  Explore the data yourself
			$("#color-legend").fadeIn();
...
//		initialzie HIV first
		...
		.attr({ offset: "0%", "stop-color": "#111", "stop-opacity": "0.0" });

		haloGradient.append("stop")
		.attr({ offset: "35%", "stop-color": "#111", "stop-opacity": "0.05" });

		haloGradient.append("stop")
		.attr({ offset: "80%",  "stop-color": "#111", "stop-opacity": "0.23" });

		haloGradient.append("stop")
		.attr({ offset: "100%",  "stop-color": "#111", "stop-opacity": "0.25" });
